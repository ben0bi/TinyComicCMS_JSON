...
function ComicCMS()
{
	...
	this.a_updateBlogPostShowForm = function(blogID)
	{
		...
		a_confirmBox(m_langDB['word_title_update_blogpost'], msg, m_langDB['word_save_blogpost'], function(dialog)
		{	
	...
	{
		a_confirmBox(m_langDB['sentence_really_leave_admin_panel_title'],m_langDB['sentence_really_leave_admin_panel'], m_langDB['word_link_mainsite'], function(dialog)
		{
			closeAllDialogs();
